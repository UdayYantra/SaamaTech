...
function(record, error, search, runtime) { 
	...
	function setLineItemBudgetValues(itemId, subsidiary , department, getclass, _total, i, recordObj, itemTotal, utilizedCurrentBudget, assetacc, expenseaccount){
        ...
        recordObj.setCurrentSublistValue({
          sublistId: 'item',
          fieldId: 'custcol_sam_actual_budget',
          line: i,
        ...
        recordObj.setCurrentSublistValue({
          sublistId: 'item',
          fieldId: 'custcol_sam_budgetutilised',
          line: i,
        ...
        recordObj.setCurrentSublistValue({
          sublistId: 'item',
          fieldId: 'custcol_sam_remaining_budget',
          line: i,
        ...
        recordObj.setCurrentSublistValue({
          sublistId: 'item',
          fieldId: 'custcol_sam_afterremainingpof',
          line: i,
        ...
        recordObj.setCurrentSublistValue({
          sublistId: 'item',
          fieldId: 'custcol_sam_used3mbudget',
          line: i,
	...
	function fetchIntitalUtilizedBudget(itemId, subsidiary , department, getclass, assetacc){
		...
		filterBudget.push(search.createFilter({
		  name : 'custrecord_sam_account',
		  operator : search.Operator.ANYOF,
		  values : itemExpAccID
		}));

		filterBudget.push(search.createFilter({
		  name : 'custrecord_sam_subsidiaryub',
		  operator : search.Operator.ANYOF,
		  values : subsidiary
		}));
		...
		if(department) {
			filterBudget.push(search.createFilter({
			name : 'custrecord_sam_departmentub',
		...
		columnBudget.push(search.createColumn({
		  name : 'custrecord_sam_usedbudget3m'
		}));
		
		
		
		var budgetimportSearchObj = search.create({
		  "type" : 'customrecord_sam_budgetutilized',
